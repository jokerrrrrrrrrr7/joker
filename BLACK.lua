...
local hash = database:sismember(bot_id.."BLACK:Basic:Constructor23"..msg.chat_id_, msg.sender_user_id_) 
...
if hash or DevBLACK(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
if hash or DevBLACK(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevBLACK(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevBLACK(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or DevBLACK(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
elseif database:sismember(bot_id.."BLACK:Basic:Constructor23"..chat_id, user_id) then
var = "المالك"
elseif database:sismember(bot_id.."BLACK:Basic:Constructor"..chat_id, user_id) then
...
function Function_BLACK(arg, data)
msg = arg.msg
if data.id_ then
...
tdcli_function ({ID = "SearchPublicChat",username_ = text},Function_BLACK,{msg=msg})
...
function Function_BLACK(extra, result, success)
database:srem(bot_id.."BLACK:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
function Function_BLACK(extra, result, success)
if result.id_ then
database:srem(bot_id.."BLACK:Basic:Constructor23"..msg.chat_id_, result.id_)
...
function Function_BLACK(extra, result, success)
database:sadd(bot_id.."BLACK:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."BLACK:Basic:Constructor23"..msg.chat_id_, result.id_)
...
Namebot = (database:get(bot_id.."BLACK:Name:Bot") or "ديترويت")
ArrayRdods = {
"تراك ازعجتنا",
...
database:set(bot_id.."BLACK:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_,true)
database:del(bot_id.."BLACK:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"࿇┇  ارسل الكلمه التري تريد اضافتها للرد العام")
return false 
end

if text and DevBLACK(msg) and database:get(bot_id.."BLACK:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_) then
database:del(bot_id.."BLACK:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_)
database:set(bot_id.."BLACK:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_, '࿇┇ الان ارسل الرد الذي تريد اضافته للعام \n࿇┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
return false
end

if text and DevBLACK(msg) and database:get(bot_id.."BLACK:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_) then
Klma = database:get(bot_id.."BLACK:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_)
Jwab = text
...
if text == "مسح رد عام" and DevBLACK(msg) then 
database:set(bot_id.."BLACK:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
if text == 'تعين الايدي عام' and DevBLACK(msg) then
database:setex(bot_id.."BLACK:Set:Id:All"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
send(msg.chat_id_, msg.id_,[[
   ࿇┇ ارسل الان النص
   ࿇┇ يمكنك اضافه :
   - `#username` > اسم المستخدم
...
if text == 'حذف الايدي عام' or text == 'مسح الايدي عام' and DevBLACK(msg) then
database:del(bot_id.."BLACK:KleshIDALLBOT")
send(msg.chat_id_, msg.id_, '࿇┇تم ازالة كليشة الايدي ')
return false  
end 

if database:get(bot_id.."BLACK:Set:Id:All"..msg.chat_id_..""..msg.sender_user_id_) then 
database:del(bot_id.."BLACK:Set:Id:All"..msg.chat_id_..""..msg.sender_user_id_) 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"࿇┇تم الغاء تعين الايدي عام") 
return false  
end 
database:set(bot_id.."BLACK:KleshIDALLBOT",text:match("(.*)"))
...
if text == "تنظيف الجروبات" and DevBLACK(msg) then
...
download_to_file('https://raw.githubusercontent.com/jokerrrrrrrrrr7/joker/main/BLACK.lua', 'BLACK.lua') 
download_to_file('https://raw.githubusercontent.com/jokerrrrrrrrrr7/joker/main/start.lua', 'start.lua') 
dofile('BLACK.lua')  
return false
end
...
if DevBLACK(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAMBLACKX/files_tshake/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAMBLACKX/files_tshake/master/files_tshake/"..file)
if res == 200 then
...
Text = [[
࿇┇ Welcome to Source
࿇┇[ Tm   -  ”DeTroit”](t.me/BLACK_TEAM_4)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
࿇┇[DeTroit TEAM](t.me/BLACK_TEAM_84)
...
࿇┇[CHANNEL Tumblr](t.me/BLACK_TEAM_4)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
...
tdcli_function ({ID = "SearchPublicChat",username_ = username[2]}, Function_BLACK, nil)
return false
end
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
database:sadd(bot_id..'BLACK:Basic:Constructor23'..msg.chat_id_, owner_id)
end
end
end,nil)
...
local NumMsg = database:get(bot_id..'BLACK:messageUser'..data.chat_id_..':'..data.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."BLACK:Comd:New:rt:User:"..data.chat_id_..Id) or Get_Rank(Id,data.chat_id_)
local message_edit = database:get(bot_id..'BLACK:message_edit'..data.chat_id_..data.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."Tshak:Add:Num"..data.chat_id_..data.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."BLACK:Add:Memp"..data.chat_id_..":"..data.sender_user_id_) or 0
local Total_Photp = (taha.total_count_ or 0)
local Texting = {
'صورتك فدشي 😘😔❤️',
"صارلك شكد مخليه ",
...
local Id = users[2]
local NumMsg = database:get(bot_id..'BLACK:messageUser'..data.chat_id_..':'..users[2]) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."BLACK:Comd:New:rt:User:"..data.chat_id_..Id) or Get_Rank(Id,data.chat_id_)
local message_edit = database:get(bot_id..'BLACK:message_edit'..data.chat_id_..users[2]) or 0
local Num_Games = database:get(bot_id.."Tshak:Add:Num"..data.chat_id_..users[2]) or 0
local Add_Mem = database:get(bot_id.."BLACK:Add:Memp"..data.chat_id_..":"..users[2]) or 0
local Total_Photp = (taha.total_count_ or 0)
local Texting = {
'صورتك فدشي 😘😔❤️',
"صارلك شكد مخليه ",
...
database:set(bot_id.."BLACK:Lock:AddMempar"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text and DevBLACK(msg) and database:get(bot_id.."BLACK:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_) then
   database:del(bot_id.."BLACK:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_)
...
local Name_Bot = (database:get(bot_id.."BLACK:Name:Bot") or "ديترويت")
